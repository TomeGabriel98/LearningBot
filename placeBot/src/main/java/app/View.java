...
public class View implements Observer {
	...
	TelegramBot bot = TelegramBotAdapter.build("624924108:AAFYymBXQHxumod6wqewZIHrDcKK-GrPhg8");
			...
			try {
				...
				for (Update update : updates) {
					...
					if (locais.contains(categoria)) {
						KeyboardButton button = new KeyboardButton("Enviar Localiza�ao");
						...
						sendResponse = bot
								.execute(new SendMessage(update.message().chat().id(), "Me envie sua localiza��o")
										.replyMarkup(reply));
